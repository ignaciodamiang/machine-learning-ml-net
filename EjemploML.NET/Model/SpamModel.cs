...
namespace AplicacionMachineLearning.Model
{
    public class SpamModel
    {
        ...
        private static string TrainDataPath => Path.Combine(AppPath, @"C:\Users\Ezee\Documents\GitHub\EjemploML.NET\AplicationMachineLearning.Service\data\SMSSpamCollection.csv");
